...
class VKDepthStencil(SwigPyObject):
    ...
    depthTestEnable = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """``True`` if depth testing should be performed."""

    depthWriteEnable = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    stencilTestEnable = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
