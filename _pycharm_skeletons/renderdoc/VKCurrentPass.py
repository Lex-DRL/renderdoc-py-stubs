...
class VKCurrentPass(SwigPyObject):
    ...
    """The :class:`VKFramebuffer` that is currently being used."""

    renderArea = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The :class:`VKRenderArea` that is currently being rendered to."""

    renderpass = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The :class:`VKRenderPass` that is currently active."""
