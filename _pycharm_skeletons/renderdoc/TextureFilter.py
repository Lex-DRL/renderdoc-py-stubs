...
class TextureFilter(SwigPyObject):
    ...
    magnify = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The :class:`FilterMode` to use when magnifying the texture."""

    minify = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
