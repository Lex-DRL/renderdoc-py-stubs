...
class GLSampler(SwigPyObject):
    ...
    addressR = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The :class:`AddressMode` in the R direction."""

    addressS = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The :class:`AddressMode` in the S direction."""

    addressT = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The :class:`AddressMode` in the T direction."""
    ...
    """The :class:`ResourceId` of the sampler object, if a separate one is set."""

    seamlessCubeMap = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
