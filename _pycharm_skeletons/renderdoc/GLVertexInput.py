...
class GLVertexInput(SwigPyObject):
    ...
    """A list of :class:`GLVertexAttribute` with the vertex attributes."""
    ...
    primitiveRestart = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """``True`` if primitive restart is enabled for strip primitives."""

    provokingVertexLast = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """
...
"""
    ...
    vertexArrayObject = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    """A list of :class:`GLVertexBuffer` with the vertex buffers."""
