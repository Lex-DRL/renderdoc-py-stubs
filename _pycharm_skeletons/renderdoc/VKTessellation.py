...
class VKTessellation(SwigPyObject):
    ...
    domainOriginUpperLeft = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """``True`` if the tessellation domain origin is upper-left, ``False`` if lower-left."""

    numControlPoints = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
